...
- (void)updateLocation {
    if (!self.firstAuthorizationStatusDidCallback) {
        ...
        !self.authorizationStatusDidChanged ? : self.authorizationStatusDidChanged(self.authorizationStatus);
        return ;
    }
    ...
    !self.locationDidUpdate ? : self.locationDidUpdate(JXLocationCoordinatesStatusInPositioning, nil);
...
- (void)locationManager:(CLLocationManager *)manager didChangeAuthorizationStatus:(CLAuthorizationStatus)status {
    if (self.authorizationStatus != status) {
        ...
        !self.authorizationStatusDidChanged ? : self.authorizationStatusDidChanged(status);
    }
}
...
- (void)locationStatusDidChangeCallback:(JXLocationCoordinatesStatus)locationStatus locationModel:(NSArray<CLLocation *> *)locations {
    ...
    self.updating = NO;
    !self.locationDidUpdate ? : self.locationDidUpdate(locationStatus, locations);
}
