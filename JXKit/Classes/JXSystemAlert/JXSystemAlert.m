...
+ (void)sheetFromVC:(UIViewController *)viewController default0Title:(NSString *)title0 default1Title:(NSString *)title1 cancel:(NSString *)cancelTitle default0Callback:(void (^)(void))default0Callback default1Callback:(void (^)(void))default1Callback cancelCallback:(void (^)(void))cancelCallback {
