...
@property (nonatomic, readonly) JXLocationCoordinatesStatus locationStatus;
...
// 定位到经纬度信息 内部会自动停止定位
@property (nonatomic, copy) void (^locationDidUpdate)(JXLocationCoordinatesStatus locationStatus, NSArray <CLLocation *> *locations);
